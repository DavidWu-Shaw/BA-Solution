...
{
    public class BaDataStore : NHDataStore
    {
        public BaDataStore(IConnectionString connection, bool isWebApplication)
        ...
        private static string BuildConfigFilePath(bool isWebApplication)
        {
            ...
            return Path.Combine(path, "ConfigFiles\\BaDataStore.cfg.xml");
        }
