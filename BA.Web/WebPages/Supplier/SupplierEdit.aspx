<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/SetupMasterPage.master"
    AutoEventWireup="true" CodeBehind="SupplierEdit.aspx.cs" Inherits="BA.Web.WebPages.Supplier.SupplierEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="SetMBody" runat="server">
    <uc1:InstanceEdit ID="ucIEdit" runat="server" SubjectType="Supplier" />
</asp:Content>
