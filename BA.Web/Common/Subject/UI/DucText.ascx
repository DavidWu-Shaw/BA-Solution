<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DucText.ascx.cs" Inherits="BA.Web.Common.Subject.UI.DucText" %>
<table cellspacing="0" cellpadding="0" border="0">
    <tr>
        ...
        <td runat="server" id="tdInput" visible="false">
            <telerik:RadTextBox ID="txtText" runat="server">
            </telerik:RadTextBox>
        </td>
        <td>
